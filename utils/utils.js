...
async function deploy() {
  ...
  const BPNFTContractFactory = await ethers.getContractFactory(
    "BPNFTContract"
  );
  // deploy
  const BPNFTContract = await BPNFTContractFactory.deploy(
    args.mint_price,
    args.max_tokens,
    args.base_uri,
    args.royaltyArtist,
  ...
  await BPNFTContract.waitForDeployment(
    args.mint_price,
    args.max_tokens,
    args.base_uri,
    args.royaltyArtist,
  ...
  await BPNFTContract.deploymentTransaction().wait(30);
  contractAddress = await BPNFTContract.getAddress();
